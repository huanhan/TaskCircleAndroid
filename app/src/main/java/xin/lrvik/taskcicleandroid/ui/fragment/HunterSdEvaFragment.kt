...
import xin.lrvik.taskcicleandroid.presenter.HunterSdEvaPresenter
...
import xin.lrvik.taskcicleandroid.ui.adapter.RvHunterSdEvaAdapter
import xin.lrvik.taskcicleandroid.ui.adapter.RvUserReEvaAdapter
import java.util.ArrayList

class HunterSdEvaFragment : BaseMvpFragment<HunterSdEvaPresenter>(), HunterSdEvaView {
...
//            mRvHunterRunningAdapter.notifyDataSetChanged()
    ...
    var curPage: Int = 0
    var pageSize: Int = 20
    lateinit var mRvUserReEvaAdapter: RvHunterSdEvaAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mRvUserReEvaAdapter = RvHunterSdEvaAdapter(list)
        ...
        mSwipeRefresh.setOnRefreshListener {
            curPage = 0
            mPresenter.evaUserByHunter(curPage, pageSize)
        }
    ...
    companion object {
        fun newInstance(): HunterSdEvaFragment {
            var instance = HunterSdEvaFragment()
            return instance
        }
    }
}
