...
class UserSdEvaFragment : BaseMvpFragment<UserSdEvaPresenter>(), UserSdEvaView {
...
//            mRvHunterRunningAdapter.notifyDataSetChanged()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mSwipeRefresh.setOnRefreshListener {
            curPage = 0
            mPresenter.evaHunterByUser(curPage, pageSize)
        }
    ...
    companion object {
        fun newInstance(): UserSdEvaFragment {
            var instance = UserSdEvaFragment()
            return instance
        }
    }
}
