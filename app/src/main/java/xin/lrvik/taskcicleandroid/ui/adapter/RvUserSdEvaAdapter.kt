 ...
 *
 */
class RvUserSdEvaAdapter(data: List<CommentHunter>) : BaseQuickAdapter<CommentHunter, BaseViewHolder>(R.layout.item_user_re_eva, data) {
    override fun convert(helper: BaseViewHolder, item: CommentHunter) {
        ...
        helper.setText(R.id.mTvName, "我评价 ${item.name}")
